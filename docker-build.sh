...
docker build -t terrabrasilis/amazon-alert-aggregated:v2.5 --build-arg INDEX_FILE=deter-amazon-aggregated -f environment/Dockerfile .

# send to dockerhub
## docker login
docker push terrabrasilis/amazon-alert-daily:v2.5
docker push terrabrasilis/amazon-alert-aggregated:v2.5
