var Translation={
	'pt-br':{
		...
		'title-chart-agreg-fm':'Variação mensal de área do projeto DETER Intenso',
		...
		'txt22a':'As classes que representam avisos de desmatamento são Mineração, Desmatamento com vegetação e Desmatamento com solo exposto.',
		...
		'toDailyChart-fm':'Abrir o painel avisos diários para a Área Teste.',
		...
		'tituloprint-fm': ' | Variação mensal de área do projeto DETER Intenso - ano referência (Agosto a Julho)',
		'about-modal':'Sobre ',
	...
	'en':{
		...
		'title-chart-agreg-fm':'Monthly variation of (Intese DETER) project area',
		...
		'txt17':'The <strong>Selective Logging</strong> class refers to the sum of the classes Geometric Selective Logging and Disordered Selective Logging for the reference year 2015/2016, when these classes were not yet discretized.',
		...
		'txt22a':'The classes representing deforestation notices are Mining, Deforestation with vegetation and Deforestation with exposed soil.',
		'txt22b':'The <strong>Selective Logging</strong> class refers to the sum of the classes Geometric Selective Logging and Disordered Selective Logging for the reference year 2015/2016, when these classes were not yet discretized.',
		...
		'tituloprint-fm': ' | Monthly variation of the (Intense DETER) project area. - reference year (August to July)',
