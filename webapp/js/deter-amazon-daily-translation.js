var Translation={
	'pt-br':{
		...
		'nv-chart-agg':'Gráficos - Agregado de Avisos',
		...
		'tituloprint':' | Avisos diários de desmatamento na Amazônia Legal Brasileira.',
	...
	'en':{
		...
		'txt26':'Download the table with the notice in CSV format.',
		'txt27':'With filters.',
		...
		'nv-chart-agg':'Graphs - Aggregate Notice',
		...
		'tituloprint':' | Daily notice of the deforestation in Brazilian Legal Amazon.',
		'header-panel':'| DETER (Notice)',
		'header-menu':'DETER (Notice)',
		'maps-sup':'Maps',
		'analysis-sup':'Graphs',
