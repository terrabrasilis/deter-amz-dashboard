var Translation={
	'pt-br':{
		...
		'title-chart-amz': 'Análise - Bioma Amazônia',
		'page-title-amz': 'Bioma Amazônia - Avisos de Desmatamento',
		...
		'txt9b':'Alterar o intervalo:',
		'txt9c':'Carregar dados para este intervalo.',
		'txt11':'Filtro:',
		...
		'tituloprint-amz':' | Avisos diários de desmatamento no Bioma Amazônia.',
	...
	'en':{
		...
		'title-chart-amz': 'Analyses - Amazônia biome',
		'page-title-amz': 'Amazônia biome - Deforestation notices',
		...
		'txt9b':'Change the time range:',
		'txt9c':'Load data for this time range.',
		'txt11':'Filter:',
		...
		'deforestation-bt-title':'See the data of deforestation notices.',
		'deforestation-classes':'Total areas of deforestation notices.',
		'degradation-bt-title':'See the data of degradation notices.',
		'degradation-classes':'Total areas of degradation notices.',
		'custom-bt-title':'See all deforestation and degradation notices data.',
		'custom-classes':'Total area of deforestation and degradation notices.',
		...
		'tituloprint-amz':' | Daily notices of the deforestation in Amazônia biome.',
		'header-panel-amz':'| DETER (notices)',
		'header-menu-amz':'DETER (notices)',
		'maps-sup':'Maps',
		'analysis-sup':'Graphs',
